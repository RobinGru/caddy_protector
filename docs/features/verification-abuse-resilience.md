...
VERIFICATION — implementation and direct AC1–AC8 tests are complete in an uncommitted worktree. Commit the changes and repeat the focused tests on that revision before marking the feature `DONE`.
